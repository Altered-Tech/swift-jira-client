//
// AllOfWorkflowSchemeAssociationsWorkflowScheme.swift
//
...
public struct AllOfWorkflowSchemeAssociationsWorkflowScheme {
    ...
    public var lastModifiedUser: Any?
