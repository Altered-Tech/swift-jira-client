//
// ConditionGroupConfiguration.swift
//
...
public struct ConditionGroupConfiguration: Codable {
    ...
    public var conditionGroups: [ConditionGroupConfiguration]?
    ...
    public init(conditionGroups: [ConditionGroupConfiguration]? = nil, conditions: [WorkflowRuleConfiguration]? = nil, operation: Operation? = nil) {
