//
// AllOfSharePermissionProject.swift
//
...
public struct AllOfSharePermissionProject: Codable {
    ...
    public var issueTypeHierarchy: Any?
    /** List of the issue types available in the project. */
    public var issueTypes: [IssueTypeDetails]?
    /** The key of the project. */
    public var key: String?
    /** The project landing page info. */
    public var landingPageInfo: Any?
    ...
    public var projectCategory: Any?
    ...
    public init(archived: Bool? = nil, archivedBy: Any? = nil, archivedDate: Date? = nil, assigneeType: AssigneeType? = nil, avatarUrls: Any? = nil, components: [ProjectComponent]? = nil, deleted: Bool? = nil, deletedBy: Any? = nil, deletedDate: Date? = nil, _description: String? = nil, email: String? = nil, expand: String? = nil, favourite: Bool? = nil, _id: String? = nil, insight: Any? = nil, isPrivate: Bool? = nil, issueTypeHierarchy: Any? = nil, issueTypes: [IssueTypeDetails]? = nil, key: String? = nil, landingPageInfo: Any? = nil, lead: Any? = nil, name: String? = nil, permissions: Any? = nil, projectCategory: Any? = nil, projectTypeKey: ProjectTypeKey? = nil, properties: [String:Any]? = nil, retentionTillDate: Date? = nil, roles: [String:String]? = nil, _self: String? = nil, simplified: Bool? = nil, style: Style? = nil, url: String? = nil, uuid: UUID? = nil, versions: [Version]? = nil) {
