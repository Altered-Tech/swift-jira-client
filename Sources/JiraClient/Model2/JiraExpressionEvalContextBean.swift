//
// JiraExpressionEvalContextBean.swift
//
...
public struct JiraExpressionEvalContextBean {
    ...
    public var issue: AllOfJiraExpressionEvalContextBeanIssue?
    /** The collection of issues that is available under the &#x60;issues&#x60; variable when evaluating the expression. */
    public var issues: AllOfJiraExpressionEvalContextBeanIssues?
    /** The project that is available under the &#x60;project&#x60; variable when evaluating the expression. */
    public var project: AllOfJiraExpressionEvalContextBeanProject?
    /** The ID of the service desk that is available under the &#x60;serviceDesk&#x60; variable when evaluating the expression. */
    public var serviceDesk: Int64?
    /** The ID of the sprint that is available under the &#x60;sprint&#x60; variable when evaluating the expression. */
    public var sprint: Int64?

    public init(board: Int64? = nil, custom: [CustomContextVariable]? = nil, customerRequest: Int64? = nil, issue: AllOfJiraExpressionEvalContextBeanIssue? = nil, issues: AllOfJiraExpressionEvalContextBeanIssues? = nil, project: AllOfJiraExpressionEvalContextBeanProject? = nil, serviceDesk: Int64? = nil, sprint: Int64? = nil) {
        self.board = board
        self.custom = custom
