...
public struct Timetracking {
    ...
    public init(originalEstimate: String?, originalEstimateSeconds: Int64?, remainingEstimate: String?, remainingEstimateSeconds: Int64?, timeSpent: String?, timeSpentSeconds: Int64?) {
    ...
    private init(client: Components.Schemas.TimeTrackingDetails) {
