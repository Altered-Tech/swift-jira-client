...
public struct JsonTypeBean {
    ...
    internal init(client: Components.Schemas.JsonTypeBean) {
        self.configuration = client.configuration?.additionalProperties
        self.custom = client.custom
        self.customId = client.customId
