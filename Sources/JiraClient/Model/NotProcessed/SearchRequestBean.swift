...
public struct SearchRequestBean {
    ...
    public init(expand: [String]? = nil, fields: [String]? = nil, fieldsByKeys: Bool? = nil, jql: String? = nil, maxResults: Int? = nil, properties: [String]? = nil, startAt: Int? = nil, validateQuery: ValidateQuery? = nil) {
        self.expand = expand
        self.fields = fields
